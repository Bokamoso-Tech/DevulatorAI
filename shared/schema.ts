...
export const users = pgTable("users", {
  ...
  role: text("role").notNull(), // e.g., "admin", "developer"
  createdAt: timestamp("created_at").defaultNow().notNull(),
});
...
export const insertFeasibilityStudySchema = createInsertSchema(
  feasibilityStudies,
).omit({
  id: true,
  createdAt: true,
...
export type FeasibilityStudy = typeof feasibilityStudies.$inferSelect;
export type InsertFeasibilityStudy = z.infer<
  typeof insertFeasibilityStudySchema
>;
