...
export default function TechnicalFeasibility({ score, factors }: TechnicalFeasibilityProps) {
  return (
    <div className="mb-6">
      ...
      <h3 className="font-semibold text-gray-800 mb-1">Technical Feasibility Score: {formatPercentage(score)}</h3>
      <p className="text-gray-700 mb-4">
        The project has {score < 60 ? "critical" : score < 70 ? "significant" : score < 80 ? "moderate" : "minimal"} technical challenges that must be {score < 80 ? "carefully managed" : "addressed"}.
      </p>
